			...
			if (!params.isJsonNull()) {
				for (Entry<String, JsonElement> entry : params.entrySet()) {
					try {
						...
						String encodeName = URLEncoder.encode(entry.getKey(), "UTF-8")
				                .replaceAll("\\+", "%20")
				                .replaceAll("\\%21", "!")
				                .replaceAll("\\%27", "'")
				                .replaceAll("\\%28", "(")
				                ...
				                .replaceAll("\\%7E", "~"); 
						String encodeValue;
							encodeValue = URLEncoder.encode(entry.getValue().getAsString(), "UTF-8")
							        .replaceAll("\\+", "%20")
							        .replaceAll("\\%21", "!")
							        .replaceAll("\\%27", "'")
							        .replaceAll("\\%28", "(")
						...
						encodedString.append(encodeName + "=" + encodeValue+"&");
